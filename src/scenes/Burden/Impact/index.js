        ...
        return (
            <div className="Impact">
                <div className="impactItem">
                    <img src={Impact1} className="iconMedium" alt="logo" />
                    <p className="textBlack2">Extreme Weather</p>
                </div>
                <div className="impactItem">
                    <img src={Impact2} className="iconMedium" alt="logo" />
                    <p className="textBlack2">Heatwaves</p>
                </div>
                <div className="impactItem">
                    <img src={Impact3} className="iconMedium" alt="logo" />
                    <p className="textBlack2">Drought</p>
                </div>
                <div className="impactItem">
                    <img src={Impact4} className="iconMedium" alt="logo" />
                    <p className="textBlack2">Wildfires</p>
                </div>
                <div className="impactItem">
                    <img src={Impact5} className="iconMedium" alt="logo" />
                    <p className="textBlack2">Mass migration</p>
                </div>
                <div className="impactItem">
                    <img src={Impact6} className="iconMedium" alt="logo" />
                    <p className="textBlack2">Disease</p>
                </div>                                
                <div className="impactItem">
                    <img src={Impact7} className="iconMedium" alt="logo" />
